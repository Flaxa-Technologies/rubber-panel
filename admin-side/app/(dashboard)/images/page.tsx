...
const EXTENSIVE_DOCKER_HUB_CATALOG: DockerHubPreset[] = [
  ...
  {
    id: "steamcmd-host",
    name: "SteamCMD Dedicated Server Host",
    category: "GAME",
    ...
    environment: {},
    description: "Official SteamCMD container for hosting CS2, TF2, Rust, Ark, and Steam dedicated servers.",
    stars: "1.8k",
    pulls: "50M+",
    arch: ["amd64"],
    official: false,
  ...
  },
  {
    ...
    environment: { PLAYERS: "16", MULTITHREAD_ENABLED: "true" },
    description: "High-performance Palworld multiplayer dedicated server container with automatic updates.",
    stars: "1.5k",
    pulls: "10M+",
    arch: ["amd64"],
    official: false,
  ...
  },
  {
    ...
    defaultPort: 7777,
    internalPort: 7777,
    defaultStartup: "mono TerrariaServer.exe -port 7777 -world /data/world.wld",
    environment: {},
    description: "TShock for Terraria with plugin manager and administrative command console.",
    stars: "600+",
    pulls: "5M+",
    arch: ["amd64"],
    official: false,
  ...
  },
  {
    ...
    environment: { SERVER_NAME: "Rubber Valheim", WORLD_NAME: "RubberWorld", SERVER_PASS: "Secret123" },
    description: "Feature-rich Valheim dedicated server with world backup and auto-update management.",
    stars: "1.2k",
    pulls: "10M+",
    arch: ["amd64"],
    official: false,
