...
echo -e "${CYAN}[2/3] Reloading Rubber Node Daemon with new credentials...${NC}"
...
if [ "${STATUS_CODE}" = "200" ]; then
  ...
  echo -e "${YELLOW}[Notice] Credentials saved and PM2 reloaded (Heartbeat response: ${STATUS_CODE}).${NC}"
