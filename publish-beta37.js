...
const TAG = "v0.1.0-beta.37";
const NAME = "Rubber Panel v0.1.0-beta.37 — Cloud Code Sandbox Internal Port Alignment";
const BODY = `## What's New in v0.1.0-beta.37

### 💻 Cloud Code Sandbox Port Alignment
- **Explicit Allocated Port Binding**: Configured \`code-server\` to bind directly to \`0.0.0.0:\${assignedPort}\` inside the container, matching both container and host network logs (e.g. \`HTTP server listening on http://0.0.0.0:25667/\`) for seamless clarity and routing.
