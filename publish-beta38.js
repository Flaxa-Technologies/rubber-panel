...
const TAG = "v0.1.0-beta.38";
const NAME = "Rubber Panel v0.1.0-beta.38 — Dynamic Host & Port Resolution for Cloud IDE";
const BODY = `## What's New in v0.1.0-beta.38

### 🚀 Cloud IDE Automatic Address Resolution
- **Seamless Port & Host Mapping**: Updated Cloud IDE page to use \`getServerAddress()\` directly, ensuring the browser automatically connects to the exact host and allotted port (e.g. \`http://192.168.1.3:25667\`) across both embedded iframe and external tab mode.
