...
const TAG = "v0.1.0-beta.52";
const NAME = "Rubber Panel v0.1.0-beta.52 — Fullscreen Shell Console, Toolbar Controls & Esc Quick-Exit";
const BODY = `## Rubber Panel v0.1.0-beta.52

### 🚀 Highlights & Fixes
- **Fullscreen Shell Terminal Mode**: Added a 1-click Fullscreen Shell toggle on both User and Admin server console pages.
  - Immersive full-screen overlay (like a real SSH/Linux shell)
  - Auto-focused sticky input bar with command history
  - Quick-exit via <kbd>Esc</kbd> key or minimize button
- **Console Toolbar Controls**: Added dedicated Copy Logs, Clear Logs, Auto-scroll, and Quick Command Shortcuts to the terminal.
- **Instant Command Pipe & RCON**: Seamless 4-stage command execution with clean output formatting.
...
async function main() {
  ...
  try {
    ...
    execSync(`git commit -m "Release ${TAG} - Fullscreen Shell Console, Toolbar Controls & Esc Quick-Exit"`, { stdio: "inherit" });
  } catch (e) {
