...
export default function TopBar({ onToggleMenu }: { onToggleMenu?: () => void }) {
  ...
  const { discord, showDiscordButton } = useCustomization();
  ...
  return (
    <header className="saas-header">
      <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, background: "var(--bg-surface)", border: "1px solid var(--border-subtle)", borderRadius: "var(--radius-sm)", padding: "5px 10px", width: 240 }}>
